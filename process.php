...
//
		...
		if($_GET["action"]=="update")
		{
			...
			{
				$add = oci_parse($ORACLEconnection, "UPDATE HAKMONTAJ SET  RULMANALINSALGIKONTROL='".strip_tags($_POST["RULMANALINSALGIKONTROL"])."',FATURASALGIKONTROL='".strip_tags($_POST["FATURASALGIKONTROL"])."',ALINSALGIKONTROL='".strip_tags($_POST["ALINSALGIKONTROL"])."' WHERE ORDERNUM='".strip_tags($_POST["order"])."' AND TYPE='".strip_tags($_POST["type"])."'"); 
				oci_execute($add);
				if(oci_num_rows($add)>0)
				{
					echo "true";
			...
			{
				$add = oci_parse($ORACLEconnection, "UPDATE HAKMONTAJ SET KAPLINFATURASALGIKONTROL='".strip_tags($_POST["KAPLINFATURASALGIKONTROL"])."',KAPLINALINSALGIKONTROL='".strip_tags($_POST["KAPLINALINSALGIKONTROL"])."' WHERE ORDERNUM='".strip_tags($_POST["order"])."' AND TYPE='".strip_tags($_POST["type"])."'"); 
				oci_execute($add);
				if(oci_num_rows($add)>0)
				{
					echo "true";
			...
			{
				$add = oci_parse($ORACLEconnection, "UPDATE HAKMONTAJ SET SANZIMANSALGIKONTROL='".strip_tags($_POST["SANZIMANSALGIKONTROL"])."' WHERE ORDERNUM='".strip_tags($_POST["order"])."' AND TYPE='".strip_tags($_POST["type"])."'"); 
				oci_execute($add);
				if(oci_num_rows($add)>0)
				{
					echo "true";
			...
			{
				$add = oci_parse($ORACLEconnection, "UPDATE HAKMONTAJ SET MESAFEOLC='".strip_tags($_POST["MESAFEOLC"])."',DERINLIKOLC='".strip_tags($_POST["DERINLIKOLC"])."',AGIRFAZTAPA='".strip_tags($_POST["AGIRFAZTAPA"])."',ARKADISKCAPIOLC='".strip_tags($_POST["ARKADISKCAPIOLC"])."',BEKBORUSU='".strip_tags($_POST["BEKBORUSU"])."',BESLEMEODASIMILI='".strip_tags($_POST["BESLEMEODASIMILI"])."' WHERE ORDERNUM='".strip_tags($_POST["order"])."' AND TYPE='".strip_tags($_POST["type"])."'"); 
				oci_execute($add);
				if(oci_num_rows($add)>0)
				{
					echo "true";
